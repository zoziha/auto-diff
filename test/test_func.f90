...
contains
    ...
    subroutine test_abs_valid(error)
        ...
        call check(error, b%get_value(), 2.0_rk)
    ...
    subroutine test_sqrt_valid(error)
        ...
        call check(error, b%get_value(), sqrt(2.0_rk))
    ...
    subroutine test_exp_valid(error)
        ...
        call check(error, b%get_value(), exp(2.0_rk))
    ...
    subroutine test_sin_valid(error)
        ...
        call check(error, b%get_value(), sin(2.0_rk))
    ...
    subroutine test_cos_valid(error)
        ...
        call check(error, b%get_value(), cos(2.0_rk))
    ...
    subroutine test_tan_valid(error)
        ...
        call check(error, b%get_value(), tan(2.0_rk))
    ...
    subroutine test_log_valid(error)
        ...
        call check(error, b%get_value(), log(2.0_rk))
    ...
    subroutine test_log10_valid(error)
        ...
        call check(error, b%get_value(), log10(2.0_rk))
